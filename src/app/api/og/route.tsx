      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', paddingLeft: 90, paddingRight: 80, flex: 1, justifyContent: 'center', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginBottom: 24 }}>
            <span style={{ fontSize: 80, fontWeight: 900, color: '#ffffff', lineHeight: 1, letterSpacing: -3, marginBottom: 4 }}>
              The Only
            </span>
            <span style={{
              fontSize: 80, fontWeight: 900, lineHeight: 1, letterSpacing: -3, marginBottom: 4,
          ...
          {/* Description */}
          <p style={{ fontSize: 22, color: 'rgba(255,255,255,0.65)', lineHeight: 1.5, maxWidth: 560, marginBottom: 44 }}>
            AI-vetted. Permissionless. Multi-chain. Fiat rails. DYCO refunds.
          </p>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={label} style={{
              ...
              borderRadius: 8, paddingLeft: 14, paddingRight: 14, paddingTop: 8, paddingBottom: 8, width: 180,
            }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, rgba(0,212,255,0.08), rgba(124,58,237,0.06))',
          borderTop: '1px solid rgba(255,255,255,0.06)',
          display: 'flex', alignItems: 'center', paddingLeft: 90, paddingRight: 80, justifyContent: 'space-between',
        }}>
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 16, fontWeight: 700, letterSpacing: 2 }}>Z-PAD · ZETTA ECOSYSTEM</span>
          <span style={{ color: 'rgba(0,212,255,0.7)', fontSize: 15, fontWeight: 600 }}>z-pad-app.vercel.app</span>
        </div>
      </div>
    ),
