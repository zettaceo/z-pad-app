          ...
          <div className="flex items-end justify-between flex-wrap gap-5">
            <div>
              ...
              <p className="text-white/70 mt-2 max-w-[640px]">
                Z holders govern the platform. Propose changes, vote on upgrades, steer the ecosystem.
              </p>
            </div>
            <Button>
        ...
        <div className="max-w-[1360px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              { l: 'Total Voted', v: '8.4M Z', c: 'This month' },
              { l: 'Participation Rate', v: '64%', c: '+8% MoM', up: true },
            ].map((s) => (
          ...
          <h2 className="font-[family-name:var(--font-display)] text-[1.6rem] font-extrabold tracking-[-0.025em] mb-6">
            Active proposals<span className="text-cyan-500 font-black">.</span>
          </h2>
          ...
          {PROPOSALS.map((p) => (
            <div key={p.id} className="bg-bg-075 border border-white/10 rounded-[14px] p-6 mb-4 hover:border-cyan-500/35 transition-colors">
              ...
              <div className="flex flex-col gap-2.5">
                {[
                  { label: 'For', pct: p.votes.for, color: 'bg-gradient-to-r from-green-400 to-cyan-600', text: 'text-green-400' },
